# -*- coding: utf-8 -*-
'''
Created on Sun Jan  8 13:33:50 2023
...
# les paramétre 
path = "C:/Users/Livaa/Desktop/projet data science/myData" # data folder 
labelFile = 'C:/Users/Livaa/Desktop/projet data science/labels.csv' # label des donneés dans le dossier de data 
...
fig, axs = plt.subplots(nrows=num_classes, ncols=cols, figsize=(50, 300))
fig.tight_layout()
for i in range(cols):
...
# STORE THE MODEL AS A H5 object
